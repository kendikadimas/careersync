...
export default function Login({
    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6">
                <h2 className="text-2xl md:text-3xl font-black text-slate-950 mb-2 tracking-tight">Selamat Datang</h2>
                <p className="text-slate-500 text-sm md:text-base font-medium tracking-tight">Masuk untuk melanjutkan kemajuan karier Anda.</p>
            </div>
