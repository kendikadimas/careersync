...
class WorkReadinessScoreService
{
    public function calculateForUser(User $user): ?WorkReadinessScore
    {
        ...
        foreach ($experiences as $exp) {
            ...
            $expPoints = max($expPoints, $points);
        }
        ...
        if ($totalScore >= 80) {
            ...
            $category = 'Hampir Siap';
        } elseif ($totalScore >= 40) {
            $category = 'Sedang Berkembang';
        }

        return WorkReadinessScore::create([
            'user_id' => $user->id,
            'score' => $totalScore,
            'category' => $category,
            'breakdown' => [
