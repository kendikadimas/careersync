...
function Footer() {
	return /* @__PURE__ */ jsxs("footer", {
		className: "bg-[#0B0F19] text-slate-400 border-t border-slate-800/60 pt-20 pb-10 overflow-hidden relative",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Link, {
						...
						className: "text-sm leading-relaxed mb-8 max-w-[280px] text-slate-400 font-medium",
						children: "Platform cerdas berbasis AI yang menjembatani kesenjangan antara kurikulum pendidikan dan kebutuhan industri IT masa kini."
					})]
					...
					].map((link, i) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
						href: link.href,
				...
				className: "pt-8 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2 px-4 py-1.5 bg-slate-900/50 rounded-full border border-slate-800 text-xs font-semibold text-slate-400",
					children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-emerald-500 animate-pulse" }), "Mendukung SDG 4 & SDG 8"]
				}), /* @__PURE__ */ jsxs("div", {
					className: "text-xs text-slate-500 font-medium",
					children: [
						"© ",
						(/* @__PURE__ */ new Date()).getFullYear(),
						" Kembang.in. Hak cipta dilindungi."
					]
				})]
			})]
		}), /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[300px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" })]
	});
}
//#endregion
		...
		children: [
			...
			isMobileMenuOpen && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "absolute left-0 top-0 bottom-0 w-[80%] max-w-sm sm:w-80 bg-indigo-950 text-white flex flex-col p-5 animate-in slide-in-from-left duration-300",
					children: [
						/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Dashboard | Kembangin" }), /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					className: "lg:col-span-4 bg-white rounded-lg p-5 sm:p-8 shadow-sm border border-slate-100 flex flex-col items-center text-center h-full",
					children: [
						/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								className: "mt-auto",
								children: [/* @__PURE__ */ jsx("h2", {
									className: "text-xl sm:text-3xl font-black tracking-tight mb-3 sm:mb-4",
						...
						className: "grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-6 flex-1 min-h-[160px] sm:min-h-[180px]",
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "bg-white rounded-lg p-4 sm:p-6 border border-slate-100 shadow-sm flex flex-col justify-between h-full relative overflow-hidden group col-span-1",
								children: [/* @__PURE__ */ jsx("div", {
									className: "relative z-10",
									children: /* @__PURE__ */ jsx("p", {
										className: "text-black text-[14px] sm:text-[18px] font-bold leading-tight",
										children: "Total Skills"
									})
								}), /* @__PURE__ */ jsxs("div", {
									className: "relative z-10 mt-2 sm:mt-auto",
									children: [/* @__PURE__ */ jsx("p", {
										className: "text-3xl sm:text-5xl font-black text-slate-900 tracking-tighter",
										children: skillCount
									}), /* @__PURE__ */ jsx("p", {
										className: "text-[9px] sm:text-[10px] font-bold text-black mt-1 italic leading-tight",
							...
							/* @__PURE__ */ jsxs("div", {
								className: "bg-white rounded-lg p-4 sm:p-6 border border-slate-100 shadow-sm flex flex-col justify-between text-black overflow-hidden relative h-full group col-span-2 sm:col-span-1",
								children: [/* @__PURE__ */ jsx("div", {
									className: "relative z-10",
									children: /* @__PURE__ */ jsx("p", {
										className: "text-black text-[14px] sm:text-[18px] font-bold leading-tight",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					className: "lg:col-span-8 bg-white rounded-lg p-6 sm:p-8 shadow-sm border border-slate-100",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between mb-8",
						children: [/* @__PURE__ */ jsx("h3", {
						...
						className: "w-full min-h-[120px] flex items-end",
						children: /* @__PURE__ */ jsx(GrowthChart, {
							data: growthData,
							labels: growthLabels
						})
					})]
				}), /* @__PURE__ */ jsxs("div", {
					className: "lg:col-span-4 bg-white rounded-lg p-6 sm:p-8 shadow-sm border border-slate-100 flex flex-col h-full justify-between overflow-hidden",
					children: [/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx("h3", {
					...
					children: [/* @__PURE__ */ jsxs(motion.div, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									className: "text-[8rem] sm:text-[12rem] opacity-5 group-hover:scale-150 group-hover:rotate-12 transition-transform duration-1000 select-none grayscale",
									children: f.visualIcon
								}),
								/* @__PURE__ */ jsx("div", {
									className: "absolute inset-0 flex items-center justify-center",
									children: /* @__PURE__ */ jsxs("div", {
										className: "bg-white/80 backdrop-blur-xl p-6 sm:p-10 rounded-4xl border border-white shadow-2xl flex flex-col items-center gap-6 transform -rotate-3 transition-all duration-700 group-hover:rotate-0 group-hover:scale-105",
										children: [/* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(20,184,166,0.05),transparent_50%)]" }), /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "bg-navy-900 p-8 md:p-16",
						children: [/* @__PURE__ */ jsxs("h3", {
						...
						className: "bg-navy-950 p-8 md:p-16 relative overflow-hidden",
						children: [
	...
	const steps = [
		{
			...
			visual: /* @__PURE__ */ jsxs("div", {
				className: "border-2 border-dashed border-slate-300 rounded-[32px] p-6 sm:p-8 text-center bg-[#fcfcfc] flex flex-col justify-center min-h-[340px] shadow-[inset_0_4px_20px_-10px_rgba(0,0,0,0.05)]",
				children: [
		...
		},
		{
			...
			visual: /* @__PURE__ */ jsxs("div", {
				className: "bg-white border border-slate-200/60 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] rounded-[32px] p-6 sm:p-10 min-h-[340px] flex flex-col justify-center",
				children: [/* @__PURE__ */ jsxs("div", {
		...
		},
		{
			...
			visual: /* @__PURE__ */ jsx("div", {
				className: "bg-white border border-slate-200/60 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] rounded-[32px] p-6 sm:p-10 min-h-[340px] flex items-center justify-center relative overflow-hidden",
				children: /* @__PURE__ */ jsxs("div", {
		...
		},
		{
			...
			visual: /* @__PURE__ */ jsxs("div", {
				className: "bg-[#0d1117] rounded-[32px] p-6 sm:p-8 min-h-[340px] flex items-center justify-center relative overflow-hidden",
		...
		},
		{
			...
			visual: /* @__PURE__ */ jsxs("div", {
				className: "bg-white border border-slate-200/60 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] rounded-[32px] p-6 sm:p-8 min-h-[340px] flex flex-col items-center justify-center relative overflow-hidden",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "relative inline-flex items-center justify-center mb-8",
					children: [/* @__PURE__ */ jsxs("svg", {
						className: "w-full max-w-[200px] h-auto aspect-square transform -rotate-90",
						children: [
							/* @__PURE__ */ jsx("circle", {
								cx: "100",
								cy: "100",
						...
						children: steps.map((step, idx) => /* @__PURE__ */ jsxs(motion.div, {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("h3", {
										className: "text-2xl sm:text-3xl lg:text-5xl font-black text-slate-950 mb-6 font-[family-name:var(--font-heading)] leading-tight tracking-tight",
										children: step.title
									}),
									/* @__PURE__ */ jsx("p", {
...
function CTAWithVerticalMarquee() {
	...
	return /* @__PURE__ */ jsx("section", {
		className: "bg-[#f6f6f6] pt-4 pb-8 md:pt-8 md:pb-12",
		children: /* @__PURE__ */ jsx("div", {
			className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							className: "hidden md:flex relative flex-1 h-[400px] lg:h-[550px] w-full items-center justify-center animate-fade-in-up",
...
var ContainerScroll = ({ titleComponent, children }) => {
	...
	return /* @__PURE__ */ jsx("div", {
		className: "h-auto md:h-[80rem] flex items-start justify-center relative p-4 md:px-20 md:pt-2 md:pb-10",
		ref: containerRef,
		children: /* @__PURE__ */ jsxs("div", {
...
var Card = ({ rotate, scale, children }) => {
	return /* @__PURE__ */ jsx(motion.div, {
		...
		className: "max-w-5xl -mt-4 md:-mt-12 mx-auto h-fit w-full border border-white p-2 md:p-6 bg-white/40 backdrop-blur-md rounded-[30px] shadow-xl",
		children: /* @__PURE__ */ jsx("div", {
			className: "h-auto w-full overflow-hidden rounded-2xl bg-slate-100",
			children
		})
	});
};
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		className: "relative overflow-hidden bg-[#f6f6f6] pt-12 pb-4 md:pt-8 md:pb-2",
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] [background-size:20px_20px] opacity-40" }), /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(ContainerScroll, {
				titleComponent: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "inline-flex items-center gap-2.5 bg-accent/10 border border-accent/20 rounded-full px-4 py-1.5 text-xs sm:text-[13px] font-semibold text-accent mb-6 hover:bg-accent/15 transition-colors cursor-default",
							children: "AI-Powered Skill Gap Analysis v2.0"
						}),
						/* @__PURE__ */ jsxs("h1", {
							className: "text-[38px] sm:text-[60px] font-extrabold text-slate-900 leading-[1.1] sm:leading-[66px] tracking-tight font-[family-name:var(--font-heading)]",
							children: [
								"Kembangkan Potensimu.",
								/* @__PURE__ */ jsx("br", {}),
								/* @__PURE__ */ jsx("span", {
									className: "bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent block mt-1",
				...
				children: [
					...
					/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", {
								className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] sm:w-[340px] transition-transform duration-500 group-hover:scale-105",
								children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Head, { title: "Standar Kompetensi Industri | Kembangin" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-32 h-32 sm:w-64 sm:h-64 bg-indigo-500/10 rounded-lg blur-3xl -mr-10 sm:-mr-20 -mt-10 sm:-mt-20" }), /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "absolute top-40 right-10 w-32 h-32 sm:w-64 sm:h-64 bg-teal-300/20 rounded-full blur-3xl -z-10 animate-pulse" }),
					/* @__PURE__ */ jsx("div", { className: "absolute bottom-20 left-10 w-40 h-40 sm:w-80 sm:h-80 bg-navy-400/10 rounded-full blur-3xl -z-10" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h1", {
								className: "text-4xl sm:text-5xl md:text-7xl font-extrabold text-navy-900 tracking-tight leading-[1.1] mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom duration-700 text-left md:text-center",
								children: [
									"Karir Impianmu, ",
									/* @__PURE__ */ jsx("br", {}),
									/* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							className: "text-3xl md:text-5xl font-extrabold text-navy-900 text-left md:text-center",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-32 h-32 sm:w-64 sm:h-64 bg-teal-500/20 blur-3xl z-0" }),
						/* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-32 h-32 sm:w-64 sm:h-64 bg-navy-500/20 blur-3xl z-0" }),
						/* @__PURE__ */ jsxs("div", {
							className: "relative z-10",
							children: [
								/* @__PURE__ */ jsx("h2", {
									className: "text-3xl md:text-5xl font-black text-white mb-6 md:mb-8 text-left md:text-center",
